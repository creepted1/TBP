...
function Install-ADTDeployment
{
    ...
    Show-ADTInstallationWelcome -CloseProcesses @{ Name = 'winword'; Description = "Microsoft Office Word" } -CloseProcessesCountdown 1800
    ...
    Start-ADTMsiProcess -Action Install -FilePath "LiteraCheck1.15.0_x64.msi" `
-ArgumentList 'PRODUCT_KEY="CH-12ZMUiN-ST0-X-QE588" ACCEPT_EULA_AND_TPLA=1 REMOVE_ALL_STANDALONE_PRODUCTS=1 GERMAN_LANGUAGE_SUPPORT=0 FRENCH_LANGUAGE_SUPPORT=0 SpanishLanguageSupport=0 /qn'
    ...
    Copy-ADTFile -Path '.\litera_xml\' -Destination 'C:\Program Files\Litera\Litera Check\Ribbons\' -Recurse


    ## Display a message at the end of the install.
    if (!$adtSession.UseDefaultMsi)
    {
        Show-ADTInstallationPrompt -Message 'Installation completed.' -ButtonRightText 'OK' -Icon Information -NoWait
    }
}
...
function Uninstall-ADTDeployment
{
    ...
    Uninstall-ADTApplication -Name 'Litera Check' -ApplicationType 'MSI' -FilterScript { $_.Publisher -match 'Litera' }
